...
export const WhoAmISection: FC = () => {
	return (
		<section id="who-am-i" className="flex items-center justify-center">
			<div className="flex items-center justify-between w-screen max-w-screen-lg gap-10">
				<div className="flex flex-col gap-4 items-center justify-center text-center w-full lg:items-start lg:text-start">
